import { TextureInternalFormat, TextureTarget, } from "./types.js";
import { createTexture, } from "./core.js";
/// Creates a texture that can be used as a render target for a 2D Context.
export function createCanvasTexture(args) {
...
export function draw2DGrid(ctx, args = {}) {
    // Default values.
...
export function copyCanvasToTexture(gl, ctx, texture) {
    try {
